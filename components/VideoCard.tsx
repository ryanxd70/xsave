        ...
        <div className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-2xl overflow-hidden shadow-2xl">
            ...
            <div className="p-8">
                ...
                <div className="mt-8 flex flex-col items-center">
                    <div className={`grid gap-4 w-full ${videoData.variants.length === 1 ? 'max-w-sm' : 'grid-cols-1 sm:grid-cols-2'}`}>
                    {videoData.variants.map((variant) => {
                        ...
                        const finalUrl = isAudioVariant ? '/download-twitter-mp3' : downloadUrl;
