            ...
            <header className="bg-gray-900 text-white z-40 shadow-lg">
                <div className="w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-3 flex justify-between items-center">
                    ...
                    <nav className="flex items-center gap-4">
                        ...
                        <button
                            onClick={toggleTheme}
                            className="p-2 rounded-full bg-gray-700 hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-900 focus:ring-white transition-colors"
            ...
            >
                ...
                >
                    <div className="flex justify-between items-center p-4 border-b border-gray-700">
                         ...
                         <button
                            onClick={() => setIsMenuOpen(false)}
                            className="p-2 rounded-full text-gray-300 hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-white"
